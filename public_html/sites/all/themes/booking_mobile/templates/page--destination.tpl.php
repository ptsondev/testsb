...
<div id="des-bg" style="background: url('<?php echo $des_bg; ?>') no-repeat top center;">
    <div id="des-bg2"></div>
</div>
                ...
                //echo render($page['sidebar_first']);
                    ...
                    echo '<div id="galery-wrapper2"><div id="galery-wrapper"><a id="btnShowPhotos" href="#popup-photos"><div id="des-photos-galery">';
                        ...
                        if(isset($node->field_photos[LANGUAGE_NONE][1])){
                            echo '<img src="'.image_style_url('square', $node->field_photos[LANGUAGE_NONE][1]['uri']).'">';                            
                        }
                        if(isset($node->field_photos[LANGUAGE_NONE][2])){
                            echo '<img src="'.image_style_url('square', $node->field_photos[LANGUAGE_NONE][2]['uri']).'">';                            
                        }
                    echo '</div><a></div></div>';
                echo '</div>';
